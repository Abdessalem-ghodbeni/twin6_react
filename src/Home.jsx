                    ...
                    >
                      <div className="row g-4">
                        ...
                        <div className="col-12 text-end pt-0">
                          <a className="btn btn-primary mb-n4" href="#">
                            Find ticket <i className="bi bi-arrow-right ps-3" />
                          </a>
                        </div>
                      </div>
                    </div>
          ...
          <div className="container">
            ...
            <div className="row g-4">
              ...
              <div className="col-sm-6 col-lg-4 col-xl-3">
                <div className="card bg-success bg-opacity-10 h-100 p-4">
                  {/* Image */}
                  <img src="assets/images/client/07.svg" className="w-75" alt />
                  {/* Card body START */}
                  <div className="card-body mt-4 p-0">
                    <span className="mb-1">Flat</span>
                    <h4 className="mb-1">$899 off</h4>
                    <h6 className="fw-normal">On Domestic Flights</h6>
                    <div className="d-flex justify-content-between align-items-center mt-4">
                      <div className="bg-primary bg-opacity-10 border border-2 border-primary border-dashed rounded-2 px-3 py-2">
                        <h5 className="fw-normal user-select-all mb-0">
                          LOG125F
                        </h5>
                      </div>
                      <a
              ...
              {/* Card item */}
              <div className="col-sm-6 col-lg-4 col-xl-3">
                <div className="card bg-danger bg-opacity-10 h-100 p-4">
                  {/* Image */}
                  <img src="assets/images/client/08.svg" className="w-75" alt />
                  {/* Card body START */}
                  <div className="card-body mt-4 p-0">
                    <span className="mb-1">Flat</span>
                    <h4 className="mb-1">13% off</h4>
                    <h6 className="fw-normal">On Domestic Flights</h6>
                    <div className="d-flex justify-content-between align-items-center mt-4">
                      <div className="bg-primary bg-opacity-10 border border-2 border-primary border-dashed rounded-2 px-3 py-2">
                        <h5 className="fw-normal user-select-all mb-0">
              ...
              {/* Card item */}
              <div className="col-sm-6 col-lg-4 col-xl-3">
                <div className="card bg-info bg-opacity-10 h-100 p-4">
                  {/* Image */}
                  <img src="assets/images/client/09.svg" className="w-75" alt />
                  {/* Card body START */}
                  <div className="card-body mt-4 p-0">
                    <span className="mb-1">Flat</span>
                    <h4 className="mb-1">$2,400 off</h4>
                    <h6 className="fw-normal">On International Flights</h6>
                    <div className="d-flex justify-content-between align-items-center mt-4">
                      <div className="bg-primary bg-opacity-10 border border-2 border-primary border-dashed rounded-2 px-3 py-2">
                        <h5 className="fw-normal user-select-all mb-0">
                          LOG125F
            ...
            <div className="row g-4">
              ...
              <div className="col-sm-6 col-lg-3">
                ...
                <div className="card card-img-scale overflow-hidden bg-transparent">
                  ...
                  <div className="position-absolute top-0 end-0 p-3 z-index-9">
                    <a
                      tabIndex={0}
                      className="mb-0 btn btn-white btn-round"
                  ...
                  <div className="card-img-scale-wrapper rounded-3">
                    <img
                      src="assets/images/category/flight/01.jpg"
                      className="card-img"
                      alt="hotel image"
                    />
                  </div>
                  ...
                  <div className="card-body px-2">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      <h5 className="card-title">
                        <a href="flight-list.html" className="stretched-link">
                          Thailand
                        </a>
                      </h5>
                      <h6 className="mb-0">
              ...
              <div className="col-sm-6 col-lg-3">
                ...
                <div className="card card-img-scale overflow-hidden bg-transparent">
                  ...
                  <div className="card-img-scale-wrapper rounded-3">
                    <img
                      src="assets/images/category/flight/03.jpg"
                      className="card-img"
                      alt
                    />
                  </div>
              ...
              <div className="col-sm-6 col-lg-3">
                ...
                <div className="card card-img-scale overflow-hidden bg-transparent">
                  ...
                  <div className="position-absolute top-0 end-0 p-3 z-index-9">
                    <a
                      tabIndex={0}
                      className="mb-0 btn btn-white btn-round z-index-2"
                      data-bs-toggle="popover"
                      data-bs-trigger="focus"
                      data-bs-placement="left"
                  ...
                  <div className="card-img-scale-wrapper rounded-3">
                    <img
                      src="assets/images/category/flight/02.jpg"
                      className="card-img"
                      alt="hotel image"
                    />
                  </div>
              ...
              <div className="col-sm-6 col-lg-3">
                ...
                <div className="card card-img-scale overflow-hidden bg-transparent">
                  ...
                  <div className="card-img-scale-wrapper rounded-3">
                    <img
                      src="assets/images/category/flight/04.jpg"
                      className="card-img"
                      alt
                    />
                  </div>
                  ...
                  <div className="card-body px-2">
                    ...
                    {/* Content */}
                    <p className="mb-0">
                      Filling fast, next available flight on 2nd Oct
                    </p>
                  </div>
                </div>
                {/* Card END */}
            ...
            <div className="row g-4 g-lg-5 justify-content-center">
              ...
              <div className="col-sm-6 col-md-4 text-center position-relative">
                ...
                <figure className="position-absolute top-0 start-100 translate-middle mt-8 d-none d-lg-block">
                  <svg width="154px" height="83px">
                    <path
                      className="fill-secondary opacity-4"
                ...
                <div className="px-4">
                  {/* Image */}
                  <img
                    src="assets/images/element/step-3.svg"
              ...
              <div className="col-sm-6 col-md-4 position-relative text-center pt-0 pt-lg-5">
                ...
                <div className="px-4">
                  {/* Image */}
                  <img
                    src="assets/images/element/step-2.svg"
                    className="w-150px mb-3"
                    alt
                  />
                  {/* Title */}
              ...
              <div className="col-sm-6 col-md-4 text-center">
                <div className="px-4">
                  {/* Image */}
                  <img
                    src="assets/images/element/step-1.svg"
                    className="w-150px mb-3"
                    alt
                  />
                  {/* Title */}
        ...
        <section className="py-0">
          <div className="container position-relative">
            <div className="bg-light rounded-3 position-relative p-4 p-sm-5">
              {/* Svg decoration */}
              <figure className="position-absolute top-50 start-50 d-none d-lg-block mt-n4 ms-9">
                <svg className="fill-primary" width="138px" height="33px">
              ...
              <div className="row align-items-center position-relative">
                ...
                <div className="col-lg-4 text-lg-end">
                  <a
                    ...
                    className="btn btn-lg btn-dark mb-0"
                  >
                    Book a Flight
                  </a>
                </div>
        ...
        <section>
          <div className="container">
            ...
            <div className="row g-4 g-xl-5 justify-content-between">
              <div className="col-md-6">
                ...
                <div className="card bg-transparent">
                  ...
                  <div className="card-body px-3">
                    <h4>
                      <a href="blog-detail.html" className="stretched-link">
              ...
              <div className="col-md-6">
                {/* Card START */}
                <div className="card bg-transparent mb-4 mb-md-5">
                  <div className="row align-items-center">
                    ...
                    <div className="col-sm-8">
                      ...
                      <div className="card-body p-sm-0">
                        ...
                        <p className="mb-0">Jacqueline Miller</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-sm-8">
                      ...
                      <div className="card-body p-sm-0">
                        ...
                        <p className="mb-0">Frances Guerrero</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-sm-8">
                      ...
                      <div className="card-body p-sm-0">
                        ...
                        <p className="mb-0">Louis Ferguson</p>
                      </div>
                    </div>
                  </div>
                </div>
